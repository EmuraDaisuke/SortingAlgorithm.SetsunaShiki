...
---
[颯式（はやてしき）](https://github.com/EmuraDaisuke/SortingAlgorithm.HayateShiki)と[焔式（はやてしき）](https://github.com/EmuraDaisuke/SortingAlgorithm.HomuraShiki)も併せて読んでいただけると、より楽しめるかも知れません。  
